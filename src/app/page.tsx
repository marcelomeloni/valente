          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="font-serif text-3xl font-bold text-zinc-900 sm:text-4xl">
                Um legado para o ensino e a tecnologia
              </h2>
              <p className="mt-6 text-lg leading-8 text-zinc-600">
                Este acervo digital tem como objetivo preservar, organizar e democratizar o acesso à vasta obra do Professor Valente. Aqui, pesquisadores, educadores e estudantes podem encontrar décadas de publicações que moldaram o pensamento sobre a tecnologia na educação brasileira.
              </p>
            </div>
          </div>
        </section>

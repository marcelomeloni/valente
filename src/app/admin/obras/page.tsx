  ...
  return (
    <div className="mx-auto max-w-5xl p-6 lg:p-8">
      <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 font-sans text-sm text-zinc-500">
            Gerencie as publicações, livros e documentos cadastrados no sistema.
          </p>
        </div>
      ...
      <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white p-8 text-center text-zinc-500 shadow-sm">
        <p>Ainda não há banco de dados conectado para exibir obras.</p>
        <p className="mt-2 text-sm text-zinc-400">Em breve, esta tela exibirá qual usuário cadastrou cada obra, através da coluna "Cadastrado por".</p>
      </div>
    </div>
  );
}

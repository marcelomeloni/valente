        ...
        <div className="bg-white dark:bg-zinc-900 px-4 py-8 shadow-xl sm:rounded-2xl sm:px-10 border border-zinc-200 dark:border-zinc-800 transition-colors">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="flex w-full justify-center items-center rounded-xl border border-transparent bg-unicamp py-3.5 px-4 text-sm font-semibold text-white shadow-sm transition-all hover:bg-red-700 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-unicamp focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed"
            >
